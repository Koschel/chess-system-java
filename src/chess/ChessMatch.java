...
import chess.pieces.Knignt;
import chess.pieces.Pawn;
import chess.pieces.Queen;
import chess.pieces.Rook;

//Coração do board do chess
public class ChessMatch {
	...
	private void initialSetup() {
		...
		placeNewPiece('b', 1, new Knignt(board, Color.WHITE));
		placeNewPiece('c', 1, new Bishop(board, Color.WHITE));
		placeNewPiece('d', 1, new Queen(board, Color.WHITE));
		placeNewPiece('e', 1, new King(board, Color.WHITE));
		placeNewPiece('f', 1, new Bishop(board, Color.WHITE));
		placeNewPiece('g', 1, new Knignt(board, Color.WHITE));
		...
		placeNewPiece('b', 8, new Knignt(board, Color.BLACK));
		placeNewPiece('c', 8, new Bishop(board, Color.BLACK));
		placeNewPiece('d', 8, new Queen(board, Color.BLACK));
		placeNewPiece('e', 8, new King(board, Color.BLACK));
		placeNewPiece('f', 8, new Bishop(board, Color.BLACK));
		placeNewPiece('g', 8, new Knignt(board, Color.BLACK));
